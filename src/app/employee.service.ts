...
export class EmployeeService {
  ...
  insertEmployee(employee : any){
    return this.http.post("http://localhost:8080/employee/addEmployee",employee);
  }  
  
  getAllEmployee(){
    return this.http.get("http://localhost:8080/employee/findAllEmployee");
  }
  
  getEmployeeById(Id:number){
    return this.http.get("http://localhost:8080/employee/findEmployee/"+Id);
  }
